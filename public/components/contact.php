        ...
        <div class="contact-wrap">
            <div class="contact-item">
                <div class="contact-box">
                    ...
                    <span class="contact-text">Вул. Льва Толстого 7</span>,
                    <span>Харків</span>, 
                    <span>61000</span>,
                    <span>Україна</span>
                </div>
                <div class="contact-box">
                    ...
                    <span class="contact-text">+380 59 765 43 21</span>
                </div>
                <div class="contact-box">
                    <svg class="contact-icon" width="20" height="20" aria-label="Email">
                        <use href="./assets/img/symbol-defs.svg#icon-email"></use>
                    </svg>
                    <a class="contact-link" href="mailto:contact@boxpodarunok.com" aria-label="Написати на email">contact@boxpodarunok.com</a>
                </div>
            </div>
            <div>
