<section id="booking" class="section-indentation" aria-labelledby="booking-heading">
    <div class="container">
        ...
        <form class="application-form" id="myForm" aria-labelledby="booking-heading">
            ...
            <div class="input-container">
                <textarea name="message" class="textarea-field" placeholder="Коментар до замовлення" aria-label="Коментар до замовлення"></textarea>
            </div>
            ...
            <div class="input-container">
                ...
                <label for="privacy_policy" class="checkbox-label">
                    Я ознайомлений з
                    <a class="form-link" href="/privacy-policy/">політикою конфіденційності</a>
                </label>
            </div>
